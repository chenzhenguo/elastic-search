...
public class Testpageqlr {
	public static Logger logger = LoggerFactory.getLogger(Testpageqlr.class);
	...
	public static void bulkWriteMethod(TransportClient client) throws IOException {
		...
		}).setBulkActions(20000).setBulkSize(new ByteSizeValue(2, ByteSizeUnit.MB))
