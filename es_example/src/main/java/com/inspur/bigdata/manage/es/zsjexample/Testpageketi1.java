...
public class Testpageketi1 {
	public static Logger logger = LoggerFactory.getLogger(Testpageketi1.class);
	...
	public static String index = "keti";
	public static String type = "keti";
