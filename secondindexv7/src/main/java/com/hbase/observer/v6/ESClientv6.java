...
public class ESClientv6 {
	...
	public static void initEsClient() throws UnknownHostException {
		if (client == null) {
			...
			Settings settings = Settings.builder().put("cluster.name", ESClientv6.clusterName)
			...
			for (String host : hosts) {
				client.addTransportAddress(
						new InetSocketTransportAddress(InetAddress.getByName(host), ESClientv6.nodePort));
			}
		}
	}
